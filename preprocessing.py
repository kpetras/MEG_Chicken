...
raw_filtered2 = raw_filtered.copy().filter(l_freq=None, h_freq=highpass_freq)

# %%
# Resampling, labelling channels
# Downsample the data 
raw_resampled = raw_filtered2.copy().resample(250, npad="auto")
...
raw_resampled.save('/Users/coline/Desktop/Internship/tempfile.fif', overwrite=True)
